Even though they are beneficial, unit tests should not be the single testing strategy of a team, as these tests don't ensure separate blocks of code work properly together once assembled.
